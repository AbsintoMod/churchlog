                    ...
                    <div class="card card-primary card-tabs">
                        ...
                        <div class="card-header p-0 pt-1">
                            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="tab-membro" data-toggle="pill" href="#tab-membro-tab"
                                        role="tab" aria-controls="tab-membro-tab"
                                        aria-selected="true"><?= $menu_information ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="tab-departamento" data-toggle="pill"
                                        href="#tab-departamento-tab" role="tab" aria-controls="tab-departamento-tab"
                                        aria-selected="false"><?= $menu_religious_data ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="tab-carteira-e-impresso" data-toggle="pill"
                                        href="#tab-carteira-e-impresso-tab" role="tab"
                                        aria-controls="tab-carteira-e-impresso-tab"
                                        aria-selected="false"><?= $menu_documents ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="tab-evento" data-toggle="pill" href="#tab-evento-tab"
                                        role="tab" aria-controls="tab-evento-tab"
                                        aria-selected="false"><?= $menu_address ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="tab-patrimonio" data-toggle="pill"
                                        href="#tab-patrimonio-tab" role="tab" aria-controls="tab-patrimonio-tab"
                                        aria-selected="false"><?= $menu_contact ?></a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="tab-content" id="custom-tabs-one-tabContent">
                                ...
                                <div class="tab-pane fade show active" id="tab-membro-tab" role="tabpanel"
                                    aria-labelledby="tab-membro">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="form-group col-12">
                                                <label for="matricula"
                                                    class="col-12 control-label"><?= $label_registration ?>:</label>
                                                <div class="col-12">
                                            ...
                                            <div class="form-group col-sm-12">
                                                <label for="nome"
                                                    class="col-md-10 control-label"><?= $label_name ?>:</label>
                                                <div class="col-md-12">
                                            ...
                                            <div class="form-group col-sm-12">
                                                <label for="sobrenome"
                                                    class="col-md-10 control-label"><?= $label_surname ?>:</label>
                                                <div class="col-md-12">
                                                    <input type="text" class="form-control" id="sobrenome"
                                                        placeholder="..." name="sobrenome" value="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            <label for="pai"
                                                class="col-sm-4 control-label"><?= $label_father_name ?>:</label>
                                            <div class="col-sm-12">
                                                <input name="nome_pai" type="text" class="form-control" id="pai"
                                                    placeholder="..." value="">
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="mae"
                                                class="col-sm-4 control-label"><?= $label_mother_name ?>:</label>
                                            <div class="col-sm-12">
                                                <input type="text" name="nome_mae" class="form-control" id="mae"
                                                    placeholder="..." value="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            <label for="cod_estado_civil"
                                                class="col-sm-12 control-label"><?= $label_marital_status ?>:</label>
                                            <div class="col-sm-12">
                                        ...
                                        <div class="form-group col-md-8">
                                            <label for="conjuge"
                                                class="col-sm-4 control-label"><?= $label_spouse_name ?>:</label>
                                            <div class="col-sm-12">
                                                <input type="text" name="conjuge" class="form-control" disabled
                                                    id="conjuge" placeholder="..." value="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="escolaridade_status"
                                                class="col-sm-12 control-label"><?= $label_done ?>:</label>
                                            <div class="col-sm-12">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-12 col-md-3">
                                            ...
                                            <div class="col-12">
                                                <select name="filho" onchange="possuiFilho()" class="form-control"
                                                    id="filho">
                                        ...
                                        <div class="form-group col-12 col-md-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="num_filho" id="num_filho"
                                                    class="form-control rounded-0 numero" disabled placeholder="Max.6">
                                                <span class="input-group-append">
                                                    <button type="button" id="botao_filho" class="btn btn-info btn-flat"
                                                        disabled onclick="addFilho()">Adic.</button>
                                                </span>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane fade" id="tab-departamento-tab" role="tabpanel"
                                    aria-labelledby="tab-departamento">
                                    <div class="row">
                                        <div class="form-group col-12 col-md-2">
                                            <label class="col-12 control-label"><?= $label_communing ?>?:</label>
                                            <div class="col-12">
                                                <select name="comunga" onchange="comunga()" class="form-control"
                                                    id="comunga">
                                                    <option value="" selected>...</option>
                                        ...
                                        <div class="form-group col-12 col-md-3">
                                            <label for="data_batismo"
                                                class="col-12 control-label"><?= $label_baptism_date ?>:</label>
                                            <div class="col-12">
                                                <input name="data_batismo" type="date" class="form-control"
                                                    id="data_batismo" disabled>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div id="addIgreja" class="form-group col-12 collapse">
                                            <label for="igreja_anterior"
                                                class="col-12 control-label"><?= $label_previous_church ?>:</label>
                                            <div class="col-12">
                                                <input name="igreja_anterior" type="text" class="form-control"
                                                    id="igreja_anterior" placeholder="..." value="">
                                            </div>
                                        </div>
                                    </div>
                                </div>

                                <div class="tab-pane fade" id="tab-carteira-e-impresso-tab" role="tabpanel"
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-3">
                                            ...
                                            <div class="col-12">
                                                <input name="rg" type="text" class="form-control numero" id="identidade"
                                                    placeholder="..." value="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <div class="col-12">
                                                <input name="rg_orgao" type="text" class="form-control" id="orgao_expd"
                                                    placeholder="..." value="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <div class="col-sm-12">
                                                <input name="rg_expedicao" type="date" class="form-control"
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <div class="col-sm-12">
                                                <input name="data_nascimento" type="date" class="form-control"
                                                    id="nascimento" placeholder="..." value="">
                                            </div>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="cpf" class="col-md-4 control-label">CPF:</label>
                                            <div class="col-md-12">
                                                <input type="text" class="form-control cpf" id="cpf" placeholder="..."
                                                    name="cpf" value="">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane fade" id="tab-evento-tab" role="tabpanel"
                                    aria-labelledby="tab-evento">
                                    <div class="row">
                                        <div class="form-group col-md-3">
                                            <label for="cep"
                                                class="col-md-12 control-label"><?= $label_zip_code ?>:</label>
                                            <div class="col-md-12">
                                        ...
                                        <div class="form-group col-md-9">
                                            <label for="rua"
                                                class="col-md-6 control-label"><?= $label_street ?>:</label>
                                            <div class="col-md-12">
                                                <input name="rua" type="text" class="form-control" id="rua" size="60"
                                                    placeholder="..." value="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-3">
                                            <label for="numero"
                                                class="col-md-12 control-label"><?= $label_number ?>:</label>
                                            <div class="col-md-12">
                                        ...
                                        <div class="form-group col-md-9">
                                            <label for="bairro"
                                                class="col-md-6 control-label"><?= $label_neighborhood ?>:</label>
                                            <div class="col-md-12">
                                                <input name="bairro" type="text" class="form-control" id="bairro"
                                                    size="40" placeholder="..." value="">
                                            </div>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label for="complemento"
                                                class="col-md-6 control-label"><?= $label_complement ?>:</label>
                                            <div class="col-md-12">
                                                <input name="complemento" type="text" class="form-control"
                                                    id="complemento" placeholder="..." value="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            <label for="estado"
                                                class="col-sm-12 control-label"><?= $label_state ?>:</label>
                                            <div class="col-sm-12">
                                        ...
                                        <div class="form-group col-md-8">
                                            <label for="cidade"
                                                class="col-sm-12 control-label"><?= $label_city ?>:</label>
                                            <div class="col-sm-12">
                                ...
                                <div class="tab-pane fade" id="tab-patrimonio-tab" role="tabpanel"
                                    aria-labelledby="tab-patrimonio">
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            <label for="telefone"
                                                class="col-sm-12 control-label"><?= $label_telephone ?>:</label>
                                            <div class="col-sm-12">
                                                <input name="telefone" type="text" class="form-control phone_with_ddd"
                                                    id="telefone" placeholder="..." value="">
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="celular"
                                                class="col-sm-12 control-label"><?= $label_cell_phone ?>:</label>
                                            <div class="col-sm-12">
                                                <input name="celular" type="text" class="form-control celular_com_9"
                                                    id="celular" placeholder="..." value="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            <label for="email"
                                                class="col-sm-12 control-label"><?= $label_email ?>:</label>
                                            <div class="col-sm-12">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" onclick='addCampo()'
                            class="btn btn-primary"><?= $button_confirm ?></button>
                    </div>
                </div>
            </div>
        </div><!-- /Modal -->
