                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card card-widget widget-user shadow">
                                ...
                                <div class="widget-user-image">
                                    <img class="img-circle elevation-2 link-foto" onclick="window.location.href='setor.php'" src="../../../../dist/img/avatar/avatar_boy_128x128.png" alt="emblema_128*128">
                                </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card card-widget widget-user shadow-lg">
                                ...
                                <div class="widget-user-image">
                                    <img class="img-circle link-foto" onclick="window.location.href='setor.php'" src="../../../../dist/img/avatar/avatar_boy_128x128.png" alt="emblema_128*128">
                                </div>
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-sm-4 border-right">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card card-widget widget-user shadow-lg">
                                ...
                                <div class="widget-user-image">
                                    <img class="img-circle link-foto" onclick="window.location.href='setor.php'" src="../../../../dist/img/avatar/avatar_girl_128x128.png" alt="emblema_128*128">
                                </div>
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-sm-4 border-right">
