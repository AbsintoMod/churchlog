                            ...
                            <div class="card card-primary card-tabs">
                                <div class="card-header p-0 pt-1">
                                    <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="tab-reuniao" data-toggle="pill" href="#tab-reuniao-tab" role="tab" aria-controls="tab-reuniao-tab" aria-selected="false"><?= $menu_reunions ?></a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="tab-aviso" data-toggle="pill" href="#tab-aviso-tab" role="tab" aria-controls="tab-aviso-tab" aria-selected="false"><?= $menu_notices ?></a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="tab-requisicao" data-toggle="pill" href="#tab-requisicao-tab" role="tab" aria-controls="tab-requisicao-tab" aria-selected="false"><?= $menu_request ?></a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="card-body">
                                                                ...
                                                                <div class="card-body pt-0">
                                                                    <div class="row">
                                                                        <div class="col-7">
                                                                            ...
                                                                            <p class="text-muted text-sm"><b> <?= $label_function ?>: </b> Web Designer / UX / Graphic Artist / Coffee Lover </p>
                                                                            <ul class="ml-4 mb-0 fa-ul text-muted">
                                                                                <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span> <b><?= $label_address ?>:</b> Demo Street 123, Demo City 04312, NJ</li>
                                                                                <li class="small"><span class="fa-li"><i class="fas fa-lg fa-phone"></i></span> <b><?= $label_telephone ?></b>: + 800 - 12 12 23 52</li>
                                                                            </ul>
                                                                        </div>
                                                                        <div class="col-5 text-center">
                                                                            <img src="../../../../dist/img/avatar/avatar_girl_128x128.png" alt="perfil_128*128" class="img-circle img-fluid">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="card-footer">
                                                                    <div class="text-right">
                                                                        <a href="#" class="btn btn-sm btn-danger">
                                                                            <i class="fas fa-solid fa-x"></i> <?= $button_exclude ?>
                                                                        </a>
                                        ...
                                        <div class="tab-pane fade" id="tab-reuniao-tab" role="tabpanel" aria-labelledby="tab-reuniao">
                                            <div class="row">
                                                <div class="form-group col-12 col-sm-6">
                                                    <label for="titulo-reuniao" class="col-sm-12 control-label"><?= $label_title ?>:</label>
                                                    <div class="col-sm-12">
                                                        <input name="titulo-reuniao" type="text" class="form-control" id="titulo" placeholder="...">
                                                    </div>

                                                    <label for="data" class="col-12 col-sm-6 control-label"><?= $label_date ?>:</label>
                                                    <div class="col-12 col-sm-6">
                                                        <input name="data" type="date" class="form-control" id="data">
                                                    </div>
                                                    <label for="hora" class="col-sm-3 control-label"><?= $label_timetable ?>:</label>
                                                    <div class="col-12 col-sm-6">
                                                                ...
                                                                <a class="d-block w-100" data-toggle="collapse" href="#reuniao1">
                                                                    <div class="row text-center">
                                                                        <div class="col-12 col-sm-4">
                                                                            Variável {Titulo da Reunião}
                                                                        </div>
                                                                        <div class="col-12 col-sm-4 ">
                                                                            <?= $label_date ?>: 10/11/2021
                                                                        </div>
                                                                        <div class="col-12 col-sm-4">
                                                                            <?= $label_hour ?>: 00:00
                                                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="tab-aviso-tab" role="tabpanel" aria-labelledby="tab-aviso">
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group  col-12 col-sm-6">
                                                        <label for="chamada-aviso" class="col-12 control-label"><?= $label_member ?>:</label>
                                                        <div class=" col-12">
                                                            <select name="chamada-aviso" id="chamada-aviso" class="form-control select2" multiple  style="width: 100%;" data-placeholder="Selecione os Membros"> 
                                                                ...
                                                                <option value="6">Membro 6</option>
                                                            </select> <!--ARRAY COM NOME DOS MEMBROS ADD-->
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="card card-danger shadow-lg" style="width: 100%;">
                                                            <div class="card-header">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="card card-purple shadow-lg" style="width: 100%;">
                                                            <div class="card-header">
                                                                <h3 class="card-title">Titulo</h3>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="card card-warning shadow-lg" style="width: 100%;">
                                                            <div class="card-header">
                                                                <h3 class="card-title">Titulo</h3>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="TituloModalCentralizado"><?= $modal_title_group ?></h5>
                </div>
                <div class="form-group modal-body">
                    <div class="form-group">
                        <!--Criar select com funções do grupo-->
                        <label for="funcao">Selecione uma ou mais Funções:</label>
                        <select id="select_funcao" name="funcao" class="select2" multiple="multiple" data-placeholder="Selecione as funções" style="width: 100%;">
                ...
                <div class="modal-footer">
                    <button type="reset" class="btn btn-secondary" data-dismiss="modal"><?= $button_cancel ?></button>
                    <button type="button" class="btn btn-success"><?= $button_save ?></button>
                </div>
            </div>
        </div>
    </div>
