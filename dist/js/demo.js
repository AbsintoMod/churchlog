...
(function ($) {
  ...
  $container.append(
    '<h5 style="text-align: center;">Customizar Tela</h5><hr class="mb-2"/>'
  )
  $container.append('<h6>Tema de Cor</h6>')
  ...
  $container.append('<h6>Opções Barra de Menu</h6>')
  ...
  var $child_indent_sidebar_container = $('<div />', { class: 'mb-4' }).append($child_indent_sidebar_checkbox).append('<span>Nav Child Indent</span>')
  $container.append($child_indent_sidebar_container)

  $container.append('<h6>Opções de Texto</h6>')
