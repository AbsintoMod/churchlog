...
<head>
    ...
    <title>Bem Vindo | Church Admin</title>
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-info">
                                ...
                                <a href="#" class="small-box-footer">Mais info <i
                    ...
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-header border-0">
                                    <div class="d-flex justify-content-between">
                                        <h3 class="card-title">Frequencia Mensal</h3>
                                ...
                                <div class="card-body">
                                    <div class="d-flex">
                                        ...
                                        <p class="ml-auto d-flex flex-column text-right">
                                            ...
                                            <span class="text-muted">Média Mensal</span>
                                        </p>
                                    </div>
                                    <!-- /.d-flex -->
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-header border-0">
                                    <div class="d-flex justify-content-between">
                                        <h3 class="card-title">Conversões</h3>
                                        <a href="javascript:void(0);">View Report</a>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="d-flex">
                                        ...
                                        <p class="ml-auto d-flex flex-column text-right">
                                            ...
                                            <span class="text-muted">Média Anual</span>
                                        </p>
                                    </div>
                                    <!-- /.d-flex -->
                                    <div class="position-relative mb-4">
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2020-2021 <a href="https://www.instagram.com">Driko Corp</a>.</strong>
