...
<body class="hold-transition sidebar-mini layout-fixed dark-mode" data-panel-auto-height-mode="height">
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      <!-- Brand Logo -->
      <a href="home-dark.html" class="brand-link">
        <img src="../dist/img/logo.png" alt="Church Logo" class="brand-image img-circle elevation-3"
          style="opacity: .8">
      ...
      <div class="sidebar">
        ...
        <!-- Sidebar Menu -->
        <nav class="mt-2">
          <ul class="nav nav-legacy nav-child-indent nav-pills nav-sidebar flex-column" data-widget="treeview"
