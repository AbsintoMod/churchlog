                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card card-widget widget-user shadow">
                                ...
                                <div class="widget-user-image">    
                                    <img onclick="window.location.href='grupo.php'" class="img-circle elevation-2 link-foto" src="../../../../dist/img/avatar/avatar_girl_128x128.png" alt="Emblema">
                                </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card card-widget widget-user shadow-lg">
                                ...
                                <div class="widget-user-image">
                                    <img class="img-circle link-foto" onclick="window.location.href='grupo.php'" src="../../../../dist/img/avatar/avatar_girl_128x128.png" alt="Emblema">
                                </div>
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-sm-4 border-right">
